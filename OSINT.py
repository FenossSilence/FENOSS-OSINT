...
def show_intro():
    show_hco_ascii()
    cprint("╔══════════════════════════════════════════════════════╗", "red")
    cprint("║                   FenossSilence               ║", "red")
    cprint("║                    FENOSS TOOLKIT                       ║", "red")
    cprint("║                Author - FenossSilence (FENOSS)                 ║", "red")
    cprint("╚══════════════════════════════════════════════════════╝", "red")
    time.sleep(1)

# Show warning + open YT
def show_warning():
    cprint("\n[!] WARNING: Subscribe to use this tool", "yellow", attrs=["bold"])
    time.sleep(2)
    os.system("xdg-open https://www.youtube.com/@FenossMD")
    time.sleep(5)
